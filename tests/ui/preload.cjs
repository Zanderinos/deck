...
contextBridge.exposeInMainWorld('deck', {
 ...
 inbox:{get:async()=>inbox,refresh:async()=>inbox,onChanged:()=>()=>{}},gh:{onPrDrafts:()=>()=>{},prDetail:async()=>null,prDiff:async()=>'diff unavailable',prComments:async()=>[],prTimeline:async()=>[],review:async(_r,_n,event)=>{reviewed.push(event);return {ok:true}}}
});
